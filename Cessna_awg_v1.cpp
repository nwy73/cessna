/*
 * Cessna++ AWG (v37) – Phase-Segmented, Servo-Tracking Arbitrary Waveform Generator
 * --------------------------------------------------------------------------------
...
enum {
    ...
    kParamSeqSpeed,     // 1..32 cycles per step
...
static void drunkAdvance(struct _CessnaAwg_DTC *d) {
    for (int i=0;i<kBins;i++) {
        // Each bin takes an independent random step scaled by Wander
